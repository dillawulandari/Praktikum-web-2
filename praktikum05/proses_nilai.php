    ...
    <div class="container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!empty($_POST['nim']) && !empty($_POST['mk']) && isset($_POST['nilai'])) {
                ...
                if ($nilai >= 80) {
                    $hasil_nilai = "A";
                    $keterangan = "Anda lulus dengan nilai yang sangat baik.";
                } elseif ($nilai >= 70) {
                    $hasil_nilai = "B";
                    $keterangan = "Anda lulus dengan nilai yang baik.";
                } elseif ($nilai >= 60) {
                    $hasil_nilai = "C";
                    $keterangan = "Anda lulus dengan nilai yang cukup.";
                } elseif ($nilai >= 50) {
                    $hasil_nilai = "D";
                    $keterangan = "Anda lulus dengan nilai yang cukup.";
                } else {
                    $hasil_nilai = "E";
                    $keterangan = "Maaf, Anda belum lulus yang ujian.";
                }
